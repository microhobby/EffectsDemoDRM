...
public partial class DrawControl : UserControl
{
    ...
    private DrawCompositionCustomVisualHandler? _drawHandler;
    public bool CanDraw
    {
        get { return _drawHandler!.CanDraw; }
        set { _drawHandler!.CanDraw = value; }
    }
    ...
    protected override void OnLoaded(RoutedEventArgs routedEventArgs)
    {
        ...
        _drawHandler = new DrawCompositionCustomVisualHandler();
        _customVisual = compositor.CreateCustomVisual(_drawHandler);
